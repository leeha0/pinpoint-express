...
// 버퍼
const FixedBuffer = function (args) {
...
FixedBuffer.prototype.readShort = function () {
    const res = this.buffer.readInt16BE(this.offset);
    this.offset += 2;
    return res;
};
...
FixedBuffer.prototype.readInt = function () {
    const res = this.buffer.readInt32BE(this.offset);
    this.offset += 4;
    return res;
};
...
FixedBuffer.prototype.readBytes = function (payloadLength) {
    const res = this.buffer.readInt8(this.offset + payloadLength - 1);
